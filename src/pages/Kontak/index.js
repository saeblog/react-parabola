  ...
  return (
    <div className="py-16 parent">
      ...
      >
        ...
        <BottomLine />
        <h2 className="py-5 text-center text-accent">Silakan isi kontak @email atau chat whatsapp untuk menghubungi admin . Jika tidak ada halangan, admin akan langsung merespon pesan yang Anda kirimkan. Terima kasih.
        </h2>
      </motion.div>
      <div className="grid grid-cols-1 gap-20 mt-8 md:grid-cols-2">
        ...
        >
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">+62 811 222 1721</h3>
          </div>
          <div className="flex items-center my-6">
            <MdEmail className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></MdEmail>
            <h3 className="font-medium text-primary">sbgyogi@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
            <FaClock className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></FaClock>
            <h3 className="font-medium text-primary">Senin – Minggu, 06:00 – 20:00</h3>
          </div>
          <div className="flex items-center my-6">
            <FaLocationArrow className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></FaLocationArrow>
            <h3 className="font-medium text-primary">Bandung , Jawa Barat, 40233</h3>
          </div>
        </motion.div>
      </div>
      <motion.div
