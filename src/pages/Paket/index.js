...
const Paket = () => {
  ...
  const [activeBtn, setActiveBtn] = useState("parabolamini");
      ...
      <div className="py-16 parent ">
        ...
        >
          <div className="flex flex-wrap items-center justify-center mt-2 mb-6">
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "antenadigital" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("antenadigital");
                filterItem("antenadigital");
              }}
            >
              Antena Digital
            </button>
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "parabolamini" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("parabolamini");
                filterItem("parabolamini");
              }}
            >
              Parabola Mini
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "parabolabesar" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("parabolabesar");
                filterItem("parabolabesar");
              }}
            >
              Parabola Besar
            </button>
          ...
          <div className="flex flex-wrap items-center justify-center mt-6 mb-6">
            {activeBtn === "antenadigital" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                filterItem("antenadigital");
                setActiveBtn("antenadigital");
              }}>
                Paket Pasang <span className="text-primary">Antena TV Digital</span>
              </h3>
            )}
            {activeBtn === "parabolamini" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                filterItem("parabolamini");
                setActiveBtn("parabolamini");
              }}>
                Paket Pasang <span className="text-primary">Parabola Mini</span>
              </h3>
            )}
            {activeBtn === "parabolabesar" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                filterItem("parabolabesar");
                setActiveBtn("parabolabesar");
              }}>
                Paket Pasang <span className="text-primary">Parabola Besar</span>
              </h3>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
            {items.map((item) => (
              ...
              >
                ...
                <span className="justify-center text-center paket-featured">Promo!</span>
