...
const Service = () => {
  ...
  return (
    <div className="py-20 parent bg-neutral">
      ...
      >
        <h3 className="text-center text-accent">Solusi & Layanan</h3>
        <h1 className="text-4xl font-semibold text-center">
          Solusi <span className="text-primary">Antena Digital & Parabola</span>
        </h1>
        <BottomLine />
        <h2 className="py-5 text-center text-accent">Kami melayani pemasangan antena tv digital dan parabola jaringan satelit parabola Telkom, Chinasat, Ses9, Measat, Asiasat, Thaicom, Intelsat, ST2 dll.</h2>
      </motion.div>
