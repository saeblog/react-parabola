  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex flex-wrap items-center justify-between mt-16 mb-4">
        <span>
          <strong className="text-primary">Raffa Parabola</strong>
        </span>
        <span>
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
        ...
        <div className="px-4 py-6 rounded shadow-lg md:col-span-2 lg:col-span-1">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <EmailShareButton url={url} title="Raffa Parabola -">
              <EmailIcon size={32} round={true} />
            </EmailShareButton>
            <FacebookShareButton url={url} title="Raffa Parabola -">
              <FacebookIcon size={32} round={true} />
            </FacebookShareButton>
            <TwitterShareButton url={url} title="Twitter -">
              <TwitterIcon size={32} round={true} />
            </TwitterShareButton>
            <LinkedinShareButton url={url} title="Raffa Parabola -">
              <LinkedinIcon size={32} round={true} />
            </LinkedinShareButton>
            <WhatsappShareButton url={url} title="Raffa Parabola -">
